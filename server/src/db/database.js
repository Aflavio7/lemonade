...
async function initDatabase() {
  ...
  `);
    ...
    // Seed default settings from environment variables if available
    const defaultSettings = [
        { key: 'mail_provider', value: process.env.MAIL_PROVIDER || 'gmail' }, 
        ...
        { key: 'imap_host', value: process.env.IMAP_HOST || '' },
        { key: 'imap_port', value: process.env.IMAP_PORT || '993' },
        { key: 'imap_user', value: process.env.IMAP_USER || '' },
        { key: 'imap_pass', value: process.env.IMAP_PASS || '' },
        { key: 'imap_secure', value: process.env.IMAP_SECURE || 'true' },
        ...
        { key: 'smtp_secure', value: process.env.SMTP_SECURE || 'true' },
        { key: 'twilio_account_sid', value: process.env.TWILIO_ACCOUNT_SID || '' },
        { key: 'twilio_auth_token', value: process.env.TWILIO_AUTH_TOKEN || '' },
        { key: 'whatsapp_phone_number', value: process.env.WHATSAPP_PHONE_NUMBER || '' },
        { key: 'booking_url', value: process.env.BOOKING_URL || 'https://calendly.com/your-link' },
        { key: 'automation_enabled', value: process.env.AUTOMATION_ENABLED || 'false' },
        { key: 'check_interval_seconds', value: process.env.CHECK_INTERVAL_SECONDS || '60' },
